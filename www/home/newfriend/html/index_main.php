        ...
        <div class="body">
            <div class="container nav">
                <div class="button_wrap">
                    <a href="./index_out.php" class="btn_basic">
                        <span class="text">지출내역 작성</span>
                        <span class="arrow-right"></span>
                    </a>
                    <a href="./index_in.php" class="btn_basic">
                        <span class="text">입금내역 작성</span>
                        <span class="arrow-right"></span>
                    </a>
                    <a href="./index_history_all.php" class="btn_basic">
                        <span class="text">전체 입출금 내역</span>
                        <span class="arrow-right"></span>
                    </a>
                </div>
