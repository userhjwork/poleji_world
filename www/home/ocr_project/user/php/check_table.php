...
echo "<h2>사용자 시스템 - 데이터베이스 연결 테스트</h2>";
...
if ($conn) {
    ...
    if ($result->num_rows > 0) {
        ...
        // 테이블 구조 확인
        $result = $conn->query("DESCRIBE ocr_project_user");
        echo "<h3>사용자 테이블 구조:</h3>";
        echo "<table border='1'>";
        ...
        echo "<p style='color: red;'>❌ ocr_project_user 테이블이 존재하지 않습니다.</p>";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p style='color: red;'>❌ ocr_project_ocr_result 테이블이 존재하지 않습니다.</p>";
        echo "<p><a href='create_tables.php'>테이블 생성하기</a></p>";
    }
