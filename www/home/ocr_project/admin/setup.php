...
<body>
    ...
    <div class="step info">
        ...
        <a href="php/create_tables.php" class="btn" target="_blank">관리자 테이블 생성</a>
    </div>
    
    <div class="step info">
        <h2>3단계: 사용자 시스템 설정</h2>
        <p>사용자 시스템의 테이블도 생성합니다.</p>
        <a href="../user/php/create_tables.php" class="btn" target="_blank">사용자 테이블 생성</a>
    </div>
    
    <div class="step info">
        <h2>4단계: 로그인 테스트</h2>
        <p>설정이 완료되면 로그인을 테스트합니다.</p>
        <a href="login.php" class="btn">관리자 로그인</a>
        <a href="../user/login.php" class="btn">사용자 로그인</a>
    </div>
    
    <div class="step info">
        <h2>기본 계정 정보</h2>
        <p><strong>관리자 기본 계정:</strong> admin / admin123</p>
        <p><strong>참고:</strong> 테이블 생성 후 자동으로 생성됩니다.</p>
    </div>
</body>
</html> 